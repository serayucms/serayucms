...
class WidgetController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', 
				'actions'=>array('admin','delete','detailWidget','create','update','index','view'),
				'roles'=>array('admin'),
			),
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Install'])) {
			$model->setAttributes($_POST['Install']['zipFile']);
                        ...
                        if($model->validate()){
                            if($model->installWidget($model->zipFile))  
                                Yii::app()->user->setFlash('berhasil','Widget '.$model->getName()." berhasil di Install");
                        }
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['Widget'])) {
			...
			if ($model->save()) {
				$this->redirect(array('view','id'=>$model->id_widget));
			}
		}
