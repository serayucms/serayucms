...
class TinyMce extends CInputWidget
{
    ...
    private static $defaultSettings = array(
        ...
        'toolbar' => "insertfile  | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | print preview media | forecolor backcolor",
