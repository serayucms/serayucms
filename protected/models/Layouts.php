...
class Layouts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, file_name, id_theme', 'required'),
			array('id_theme', 'numerical', 'integerOnly'=>true),
			array('name, file_name, tipe, folder', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, file_name, id_theme', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'widgetPosisis' => array(self::HAS_MANY, 'WidgetPosisi', 'id_layouts'),
		);
	}
